...
type QonicoIoTApp struct {
	*bam.BaseApp
	...
	dataNodeKeeper datanode.DataNodeKeeper
...
func NewQonicoIoTApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		gov.StoreKey, params.StoreKey, evidence.StoreKey, upgrade.StoreKey, datanode.StoreKey,
	)
	...
	app.SetAnteHandler(
		datanode.NewDelegatedDeductFeeAnteHandler(
			app.accountKeeper,
			app.supplyKeeper,
			app.dataNodeKeeper,
